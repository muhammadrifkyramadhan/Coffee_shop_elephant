...
<body>
      ...
      <div class="container mt-3">
        <div class="row d-flex justify-content-start align-items-start main-container">
          <div class="col-md-5 col-sm-12 col-lg-5 reveal main-text mb-4 text-align-justify mt-5" data-aos="fade-up">
            <h2>Welcome to <span style="color: #ffd500ff;"> COFFEE SHOP ELEPHANT,</span></h2>
            <h4 style="color: white; font-weight: 450;">"Where Hot Flavors Meet Cool Comfort."</h4>
            <p style="font-size: 18px; text-align: justify;">
              Elephant Coffee Shop menghadirkan pengalaman menikmati kopi yang tak terlupakan, baik untuk bersantai, mengerjakan tugas, maupun berkumpul bersama teman.
              Dengan suasana cozy dan pelayanan ramah, setiap kunjungan Anda akan meninggalkan kesan yang menenangkan namun tetap penuh rasa.
              Temukan kenyamanan, kehangatan, dan kenikmatan dalam setiap tegukan di Elephant Coffee Shop.
            </p>
            <div class="buttondiv">
              <div>
                <a href="login.php">
          ...
          <div class="col-md-7 col-sm-12 col-lg-7 d-flex justify-content-center align-items-start slide-in-right main-image">
            <img src="images/cofe-bg-Photoroom.png" class="img" style=" width: 85%; height: 80%;">
          </div>
        </div>
        <div class="row">
          <!-- Menu Section -->
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 mb-4">
                    <div class="category-card" style="background-image: url('images/espreso.jpg');" data-aos="fade-up">
                      <div class="card-overlay">
                        <div class="overlay-content">
                          <h3>Coffee Based</h3>
                          <p>Kick off your day with our smooth and aromatic espresso drinks, crafted to awaken your senses and energize your coffee journey.</p>
                  ...
                  <div class="col-lg-3 col-md-6 mb-4">
                    <div class="category-card" style="background-image: url('images/Kopi_Susu_Gula_Aren.jpg');" data-aos="fade-up">
                      <div class="card-overlay">
                        <div class="overlay-content">
                          <h3>Signature Menu</h3>
                          <p>Discover our Signature Menu — a curated selection of standout creations crafted with exceptional ingredients and unforgettable flavors.</p>
                  ...
                  <div class="col-lg-3 col-md-6 mb-4">
                    <div class="category-card" style="background-image: url('images/Chocolate.jpg');" data-aos="fade-up">
                      <div class="card-overlay">
                        <div class="overlay-content">
                          <h3>Non Coffee</h3>
                          <p>Discover our range of non-coffee beverages, perfectly crafted for those who prefer something smooth, sweet, or refreshing.</p>
                  ...
                  <div class="col-lg-3 col-md-6 mb-4">
                    <div class="category-card" style="background-image: url('images/Waffle.jpg');" data-aos="fade-up">
                      <div class="card-overlay">
                        <div class="overlay-content">
                          <h3>Snacks</h3>
                          <p>Enjoy our crunchy and flavorful snacks, perfect as a companion to your favorite beverages.</p>
    ...
    <div class="container">
      <div class="row why-us-content">
        <div class="col-md-12 col-lg-6 col-sm-12 col-xs-12 mt-5 reveal d-flex justify-content-start align-items-start" data-aos="fade-up">
          <img src="images/Shopee-BG.png" width="100%" height="auto" loading="lazy" alt="delivery boy" class="w-100 delivery-img" data-delivery-boy>
        </div>
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 d-flex flex-column justify-content-center reveal" data-aos="fade-up">
          <h1>WHY <span>CHOOSE US?</span></h1>
          <p class="content">Our Coffee Elephant offers the best food delivery service with fresh and high-quality ingredients.</p>
  ...
  <!-- About Us section -->
  <div class="aboutus" id="About-Us" style="background-image: url(images/gpt.png); background-size: cover; background-position: center; background-repeat: no-repeat;">
      ...
      <div class="container ">
        ...
        <div class="story-content row mb-2">
          <div class="story-text col-lg-6 col-md-6 col-sm-12 reveal mt-2" data-aos="fade-up" data-os-interval="300">
            <p>Elephant Coffee adalah tempat di mana aroma kopi terbaik bertemu dengan suasana yang tenang dan nyaman. Kami percaya bahwa setiap cangkir kopi memiliki cerita—mulai dari pemilihan biji, teknik roasting, hingga cara penyajiannya. Barista kami menghadirkan sentuhan kreativitas pada setiap racikan, memastikan pengalaman yang memanjakan semua indera Anda.</p>
            <p>Didirikan pada 2020, Elephant Coffee terus berkembang sebagai ruang berkumpul yang hangat dan inspiratif. Dengan komitmen menggunakan biji kopi berkualitas tinggi serta bahan-bahan segar, kami menghadirkan cita rasa autentik yang membuat setiap kunjungan terasa istimewa. Bagi kami, menikmati kopi bukan sekadar rutinitas, melainkan sebuah seni yang patut dirayakan.</p>
            <p>Apakah Anda sedang mencari tempat untuk bersantai sendiri, berdiskusi dengan teman, meeting santai, atau merayakan momen spesial, Elephant Coffee menawarkan suasana elegan, modern, dan penuh kenyamanan.
              Datanglah dan temukan pengalaman menikmati kopi yang berbeda—lebih hangat, lebih dekat, dan lebih berkesan.</p>
            <a href="menu.php" class="about_btn">
              <i class="fa-solid fa-coffee"></i>Order Now
            </a>
          </div>
          <div class="story-image col-lg-6 col-md-6 col-sm-12 d-flex justify-content-end align-items-start slide-in-right" data-aos="fade-up">
            <img src="images/kopi-bg (1).png" alt="Crafting Memorable Meals" style="width: 100%; height: auto;">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="row">
        <div class="clients-carousel owl-carousel" data-aos="fade-up">
          <div class="single-box">
            ...
            <div class="content">
              <p>"Kopinya kaya aroma dan rasanya sangat nikmat, Saya suka variasi minuman dan camilan yang ada di menu. Tempat yang sempurna untuk bersantai, bekerja, atau berkumpul bersama teman."</p>
              <h4>-Dea Nur Halizah</h4>
            </div>
          </div>
          <div class="single-box">
            <div class="img-area"><img alt="" class="img-fluid" src="uploads/user-girl.png"></div>
            <div class="content">
              <p>"Proses pemesanan online sangat mudah dan lancar. Pesanan saya tiba dalam kondisi hangat dan tepat waktu. Layanan pengirimannya juga sangat profesional."</p>
              <h4>-Khansa Ramadhani</h4>
            </div>
          </div>
          <div class="single-box">
            <div class="img-area"><img alt="" class="img-fluid" src="uploads/me.png"></div>
            <div class="content">
              <p>"Tempat yang fantastis! Kopinya nikmat dan aromanya kuat, dan pilihan dessert maupun camilannya benar-benar memuaskan. Stafnya sangat ramah, dan pelayanannya cepat."</p>
              <h4>-Rifky</h4>
            </div>
          </div>
          <div class="single-box">
            <div class="img-area"><img alt="" class="img-fluid" src="uploads/mek.jpeg"></div>
            <div class="content">
              ...
              <p>"Sistem pemesanan onlinenya luar biasa. Sangat mudah untuk menyesuaikan pesanan, dan pengirimannya selalu tepat waktu. Pesanan selalu datang dalam keadaan hangat dan lezat setiap saat."</p>
              <h4>-Fasya</h4>
            </div>
          </div>
        </div>
    ...
    <div class="footer-container">
      <div class="footer-row">
        <div class="footer-col" id="contact">
          <h4>Contact Us</h4>
          <p>Jl.siliwangi, Pamulang, Tangerang Selatan</p>
          <p>Email: Elephant@gmail.com</p>
          <p>Phone: 0851 9896 7887</p>
        </div>
      ...
      <div class="footer-bottom">
        <h4>&copy; 2025 Authored by RIFKY&FASYA. All Rights Reserved.</h4>
      </div>
    </div>
  </footer>
