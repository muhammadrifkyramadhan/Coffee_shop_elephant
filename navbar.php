  ...
  <div>
    <nav class="navbar navbar-expand-md fixed-top">
      <div class="container-fluid nav-container">
        <a class="navbar-brand me-auto logo" href="index.php">Coffee Shop Elephant</a>
            ...
            <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="menu.php#coffeebased">Coffee Based</a></li>
                    <li><a class="dropdown-item" href="menu.php#signaturemenu">Signature Menu</a></li>
                    <li><a class="dropdown-item" href="menu.php#noncoffee">Non-Coffee</a></li>
                    <li><a class="dropdown-item" href="menu.php#snacks">Snacks</a></li>
                </ul>
              </li>
              <li class="nav-item">
        ...
        <button class="navbar-toggler" type="button" aria-label="Toggle navigation" id="toggleOffcanvas">
          <span class="navbar-toggler-icon" style="color: #ffd000ff"></span>
        </button>
      </div>
    </nav>
  </div>
