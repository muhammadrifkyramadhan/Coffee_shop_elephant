...
<body>
    ...
    <?php foreach ($categories as $category): ?>
        <section id="<?= strtolower(preg_replace('/[^A-Za-z0-9]/', '', $category)) ?>">
            <div id="message"></div>
                ...
                <div class="row">
                    ...
                    ?>
                        <div class="col-md-6 col-lg-3 col-sm-12 menu-item col-xs-12">
                            <div class=" mt-4" style="background-color: #FFFDE6; border-radius: 5px;">
    ...
    <div id="toast" class="toast" style="background: rgba(255, 249, 182, 0.9); border: 1px solid rgba(255, 182, 182, 1); font-size: 16px;">
