            ...
            <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <li><a class="dropdown-item" href="menu.php#appetizer">Coffee Based</a></li>
                  <li><a class="dropdown-item" href="menu.php#pizza">Signature Menu</a></li>
                  <li><a class="dropdown-item" href="menu.php#burger">Non-Coffee</a></li>
                  <li><a class="dropdown-item" href="menu.php#beverage">Snacks</a></li>
                </ul>
              </li>
              <li class="nav-item">
